(function() {
    ...
    function PreRender(opts) {
        ...
        var options = _this.options = {
            ...
            maxItems: opts && opts.maxItems || defaults.maxItems
        };
    ...
    PreRender.prototype = {
        ...
        prerender: function(href) {
            ...
            if(href && href !== this.href && this.itemCount <= this.options.maxItems){
                this.itemCount++;
                this.href = href;
                //this.remove();
                ...
                if (head) {
                    ...
                    link.setAttribute('rel', 'preconnect prefetch prerender');
